...
export class BasicComponent {
  ...
  tagList2: any = [
    ...
    { id: 668, name: '自定义颜色', customColor: '#f50' },
  ];
  tagList3: any = [
    { id: 918, name: '标签颜色1', labelStyle: 'blue-w98' },
    { id: 1769, name: '标签颜色2', labelStyle: 'green-w98' },
  ...
  tagList_custom: any = [
    { id: 1, name: '测试1', labelStyle: 'blue-w98' },
    { id: 2, name: '测试2', labelStyle: 'green-w98' },
    { id: 3, name: '测试3', labelStyle: 'yellow-w98' },
    { id: 4, name: '测试4', labelStyle: 'orange-w98' },
  ];
