...
export class LayoutDemoComponent {
  LayoutBasic: Array<DevuiSourceData> = [
    ...
    { title: 'CSS', language: 'css', code: require('!!raw-loader!./basic/layout-basic.component.scss') },
  ];
  ...
  LayoutTop: Array<DevuiSourceData> = [
    ...
    { title: 'CSS', language: 'css', code: require('!!raw-loader!./top/top.component.scss') },
  ];
  ...
  LayoutTopAside: Array<DevuiSourceData> = [
    ...
    { title: 'CSS', language: 'css', code: require('!!raw-loader!./top-aside/top-aside.component.scss') },
  ];
}
