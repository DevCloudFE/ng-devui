...
|     nodeDragStart     | `EventEmitter<{ event: DragEvent, treeNode:`[`TreeNode`](#treenode)` }>` | Optional. It is the node dragStart event callback function. It returns the drag event and the dragging node info                                                              | [可拖拽树](demo#drag-and-drop-tree)     |
