...
| canActivateParentNode |                 `boolean`                 |      true       |                                   Optional. indicates whether a parent node is optional. If the value is false, the nodeChecked event is triggered when a node is clicked.                                    | [Checkable Tree](demo#checkable-tree)                              |
