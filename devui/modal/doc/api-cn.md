...
|        component         |           `Component`           |    --    | 可选，弹出框组件，弹出框会显示组件内容         | [自定义对话框](demo#custom-dialog)            |
|         injector         |           `Injector`            |   true   | 可选，可以选择指定将用作组件的父级的注射器。   |
|           data           |            `object`             |    --    | 可选，传入component实例中的属性                | [自定义对话框](demo#custom-dialog)            |
|       showAnimate        |            `boolean`            |    --    | 可选，是否显示动画，                           | [自定义对话框](demo#custom-dialog)            |
...
|         content          |       `string、Component`       |     --     | 可选，弹出框内容，支持字符串和组件                                       | [标准对话框](demo#standard-dialog)             |
...
|       showAnimate        |            `boolean`            |     --     | 可选，是否显示动画，                                                     | [拦截对话框关闭](demo#intercept-dialog-closed) |
