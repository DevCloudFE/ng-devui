...
| dateConfig | `any` | See the following description. | Optional, It is a configuration parameter. | [Basic usage](demo#datepicker-default) |
| dateFormat | `any` | 'y/MM/dd'\| 'y/MM/dd HH:mm' | Optional, Formatting is supported. The default value varies depending on whether showTime is specified. | [Format](demo#datepicker-format) |
...
### Set the parameters as follows and transfer the parameters to the dateConfig attribute.
...
| dateConfig | `any` | See the following description. | Optional, It is a configuration parameter. | [Date range selector formatting](demo#datepicker-range-format) |
| dateFormat | `any` | `'y/MM/dd'\|'y/MM/dd HH:mm'` | Optional, Formatting the input data | [Date range selector formatting](demo#datepicker-range-format) |
...
| dateConverter | `function` | DefaultDateConverter |Optional, formatting and parsing functions. |
| dateConfig | `any` | See the following description. | Optional, It is a configuration parameter. | [Dual date selector formatting](demo#two-date-picker-format) |
| dateFormat | `any` | `'y/MM/dd'\|'y/MM/dd HH:mm'` | Optional, Formatting the input data | [Dual-date selector formatting](demo#two-date-picker-format) |
