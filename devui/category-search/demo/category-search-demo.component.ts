...
export class CategorySearchDemoComponent implements OnInit, OnDestroy {
  basicSource: Array<DevuiSourceData> = [
    ...
    { title: 'DATA', language: 'typescript', code: require('./demo-data.ts?raw') },
  ];
  autoScrollSource: Array<DevuiSourceData> = [
    { title: 'HTML', language: 'xml', code: require('./auto-scroll/auto-scroll.component.html?raw') },
    { title: 'TS', language: 'typescript', code: require('./auto-scroll/auto-scroll.component.ts?raw') },
    { title: 'DATA', language: 'typescript', code: require('./demo-data.ts?raw') },
  ];
  navItems = [];
